...
@media screen and (min-height: 721px) {
    ...
    <body>
        ...
        <main class="l-main">
            ...
            <section class="about section bd-container" id="about">
                <div class="about__container  bd-grid">
                    ...
                    <img src="/images/about.jpg" alt="" class="about__img" id="about_image">
                </div>
            </section>
            ...
            <section class="contact section bd-container" id="contact">
                <div class="contact__container bd-grid">
                    ...
                    <div class="contact__button">
                        <button onclick="document.getElementById('id01').style.display='block'" class="button">Contact us now</button>
        ...
        <footer class="footer section bd-container">
            ...
            <p class="footer__copy">&#169; 2020 JBratoc. All right reserved</p>
        </footer>
              ...
              <div class="w3-container w3-center">
                ...
                <div >
                    <form method="POST" action="{{ route('clientes.store') }}"  role="form" style="display: grid;">
                        ...
                        <input type="text" placeholder="Apellido Materno" style="margin-top: 10px;" name="motherlastname" id="motherlastname"/>
                        <input type="text" placeholder="Email" style="margin-top: 10px;" name="email" id="email"/>
                        <input type="text" placeholder="Asunto" style="margin-top: 10px;" name="affair" id="affair"/>
                        <input type="text" placeholder="Mensaje" style="margin-top: 10px;" name="names" id="names"/>
                        <br/>
                        <button style="margin-bottom: 20px;" type="submit" >Send Message</button>
                 </form>
                </div>
              </div>
            </div>
